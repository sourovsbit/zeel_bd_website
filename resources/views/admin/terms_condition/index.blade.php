...
<div class="content">
    ...
    <!-- link 2 -->
    @slot('link_two')
    @lang('terms_condition.terms_condition')
    @endslot
    @slot('link_two_url')
    {{route('terms_condition.index')}}
    @endslot
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form method="post" action="{{route('terms_condition.update',$data['data']->id)}}" enctype="multipart/form-data">
                @csrf
                @method("PUT")
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-12 mt-4">
                        <label>@lang('terms_condition.description')</label>
