...
<div class="content">
    ...
    <!-- Active Link -->
    @slot('active_link')
    @lang('create_career.create_title')
    @endslot
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form method="post" action="{{route('create_career.store')}}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-12 mt-2">
                        ...
                        <input type="text" class="form-control form-control-sm @error('job_title') is-invalid @enderror" name="job_title" id="job_title"  value="{{ old('job_title') }}">
                        @error('job_title')
                            <div class="alert alert-danger">
                                {{ $message }}
                            </div>
