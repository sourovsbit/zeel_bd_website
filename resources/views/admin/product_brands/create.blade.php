...
<div class="content">
    ...
    <!-- Active Link -->
    @slot('active_link')
    @lang('product_brands.create_title')
    @endslot
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form method="post" action="{{route('product_brands.store')}}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 col-12 mt-2">
                        ...
                        <input type="text" class="form-control form-control-sm @error('brand_name') is-invalid @enderror" name="brand_name" id="brand_name"  value="{{ old('brand_name') }}">
                        @error('brand_name')
                            <div class="alert alert-danger">
                                {{ $message }}
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-12 mt-2">
                        ...
                        <input type="text" class="form-control form-control-sm @error('brand_name_bn') is-invalid @enderror" name="brand_name_bn" id="brand_name_bn"  value="{{ old('brand_name_bn') }}">
                        @error('brand_name_bn')
                            <div class="alert alert-danger">
                                {{ $message }}
                            </div>
