...
<div class="content">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form method="post" action="{{route('newsevents.store')}}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-12 mt-2">
                        ...
                        <input type="date" class="form-control form-control-sm @error('date') is-invalid @enderror" name="date" id="date"  value="{{ old('date') }}">
                        @error('date')
                            <div class="alert alert-danger">
                                {{ $message }}
                            </div>
