...
<div class="content">
    ...
    <!-- link 2 -->
    @slot('link_two')
    @lang('create_blogs.create_blogs')
    @endslot
    @slot('link_two_url')
    {{route('create_blogs.index')}}
    @endslot


    <!-- Active Link -->
    @slot('active_link')
    @lang('create_blogs.create_title')
    @endslot
    ...
    @if(Auth::user()->can('Create Blogs view'))
    <!-- button one -->
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form method="post" action="{{route('create_blogs.store')}}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-12 mt-2">
                        <label>@lang('create_blogs.title')</label><span class="text-danger">*</span>
                    ...
                    <div class="col-lg-6 col-md-12 col-12 mt-2">
                        <label>@lang('create_blogs.description')</label>
                        <textarea type="text" class="form-control form-control-sm @error('description') is-invalid @enderror" name="description"  id="summernote"></textarea>
                        @error('description')
                        <div class="alert alert-danger">
                            {{ $message }}
                        </div>
