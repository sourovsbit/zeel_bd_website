...
<div class="content">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form method="post" action="{{route('sub_unit.store')}}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 col-12 mt-2">
                        ...
                        <input type="text" class="form-control form-control-sm @error('sub_unit_name') is-invalid @enderror" name="sub_unit_name" id="sub_unit_name"  value="{{ old('sub_unit_name') }}">
                        @error('sub_unit_name')
                            <div class="alert alert-danger">
                                {{ $message }}
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-12 mt-2">
                        ...
                        <input type="text" class="form-control form-control-sm @error('sub_unit_name_bn') is-invalid @enderror" name="sub_unit_name_bn" id="sub_unit_name_bn"  value="{{ old('category_name_bn') }}">
                    ...
                    <div class="col-lg-3 col-md-6 col-12 mt-2">
                        ...
                        <input type="text" class="form-control form-control-sm @error('sub_unit_data') is-invalid @enderror" name="sub_unit_data" id="sub_unit_name_bn"  value="{{ old('category_name_bn') }}">
                        @error('sub_unit_data')
                            <div class="alert alert-danger">
                                {{ $message }}
                            </div>
