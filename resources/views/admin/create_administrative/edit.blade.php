...
<div class="content">
    ...
    <!-- link 2 -->
    @slot('link_two')
    @lang('create_administrative.create_administrative')
    @endslot
    @slot('link_two_url')
    {{route('create_administrative.index')}}
    @endslot


    <!-- Active Link -->
    @slot('active_link')
    @lang('create_administrative.edit_title')
    @endslot
    ...
    @if(Auth::user()->can('Administrative Message view'))
    <!-- button one -->
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form method="post" action="{{route('create_administrative.update',$data['data']->id)}}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-12 mt-2">
                        <label>@lang('create_administrative.name')</label><span class="text-danger">*</span>
                    ...
                    <div class="col-lg-6 col-md-6 col-12 mt-2">
                        <label>@lang('create_administrative.title')</label><span class="text-danger">*</span>
                    ...
                    <div class="col-lg-6 col-md-12 col-12 mt-2">
                        <label>@lang('create_administrative.description')</label>
                    ...
                    <div class="col-lg-6 col-md-6 col-12 mt-2">
                        ...
                        <br>
                        @php
                            $pathImage = public_path().'/backend/Administrative/AdministrativeImage/'.$data['data']->image;
                        @endphp
                        @if(file_exists($pathImage))
                            <img src="{{ asset('backend/Administrative/AdministrativeImage') }}/{{ $data['data']->image }}" alt="" class="img-fluid" style="height: 70px;">
                        @endif
                    </div>
