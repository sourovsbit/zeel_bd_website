...
<div class="content">
    ...
    <!-- link 2 -->
    @slot('link_two')
    @lang('return_policy.return_policy')
    @endslot
    @slot('link_two_url')
    {{route('return_policy.index')}}
    @endslot
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form method="post" action="{{route('return_policy.update',$data['data']->id)}}" enctype="multipart/form-data">
                @csrf
                @method("PUT")
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-12 mt-4">
                        <label>@lang('return_policy.description')</label>
