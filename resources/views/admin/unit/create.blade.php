            ...
            <form method="post" action="{{route('unit.store')}}">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 col-12 mt-2">
                        ...
                        <input type="text" class="form-control form-control-sm @error('unit_name') is-invalid @enderror" name="unit_name" id="unit_name"  value="{{ old('unit_name') }}">
                        @error('unit_name')
                            <div class="alert alert-danger">
                                {{ $message }}
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-12 mt-2">
                        ...
                        <input type="text" class="form-control form-control-sm @error('unit_name_bn') is-invalid @enderror" name="unit_name_bn" id="unit_name_bn"  value="{{ old('unit_name_bn') }}">
                        @error('unit_name_bn')
                            <div class="alert alert-danger">
                                {{ $message }}
                            </div>
