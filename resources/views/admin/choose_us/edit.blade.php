            ...
            <form method="post" action="{{route('choose_us.update',$data['data']->id)}}" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-12 mt-2">
                        ...
                        <br>
                        @php
                            $pathImage = public_path().'/backend/WhyChooseUs/WhyChooseUsImage/'.$data['data']->image;
                        @endphp
                        @if(file_exists($pathImage))
                            <img src="{{ asset('backend/WhyChooseUs/WhyChooseUsImage') }}/{{ $data['data']->image }}" alt="" class="img-fluid" style="height: 70px;">
                        @endif
                    </div>
