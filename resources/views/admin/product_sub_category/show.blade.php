...
<div class="content">
    ...
    <!-- link 2 -->
    @slot('link_two')
    @lang('product_sub_category.sub_category')
    @endslot
    @slot('link_two_url')
    ...
    <!-- Active Link -->
    @slot('active_link')
    @lang('product_sub_category.details')
    @endslot
    ...
    <div class="card">
        <div class="card-body">
            <h4>
                ...
                {{ $data['data']->sub_category_name ?: $data['data']->sub_category_name_bn }}
                @else
                {{ $data['data']->sub_category_name_bn ?: $data['data']->sub_category_name }}
                @endif
            </h4>
            @php
