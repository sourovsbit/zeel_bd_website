...
<div class="content">
    ...
    <!-- link 2 -->
    @slot('link_two')
    @lang('create_certificates.create_certificates')
    @endslot
    @slot('link_two_url')
    {{route('create_certificates.index')}}
    @endslot


    <!-- Active Link -->
    @slot('active_link')
    @lang('create_certificates.edit_title')
    @endslot
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form method="post" action="{{route('create_certificates.update',$data['data']->id)}}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-12 mt-2">
                        <label>@lang('create_certificates.title')</label><span class="text-danger">*</span>
                    ...
                    <div class="col-lg-6 col-md-6 col-12 mt-2">
                        ...
                        <br>
                        @php
                            $pathImage = public_path().'/backend/Certificates/CertificatesImage/'.$data['data']->image;
                        @endphp
                        @if(file_exists($pathImage))
                            <img src="{{ asset('backend/Certificates/CertificatesImage') }}/{{ $data['data']->image }}" alt="" class="img-fluid" style="height: 70px;">
                        @endif
                    </div>
