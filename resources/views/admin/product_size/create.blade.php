...
<div class="content">
    ...
    <!-- Active Link -->
    @slot('active_link')
    @lang('product_size.create_title')
    @endslot
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form method="post" action="{{route('product_size.store')}}">
                @csrf
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 col-12 mt-2">
                        ...
                        <input type="text" class="form-control form-control-sm @error('size_name') is-invalid @enderror" name="size_name" id="size_name"  value="{{ old('size_name') }}">
                        @error('size_name')
                            <div class="alert alert-danger">
                                {{ $message }}
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-12 mt-2">
                        ...
                        <input type="text" class="form-control form-control-sm @error('size_name_bn') is-invalid @enderror" name="size_name_bn" id="size_name_bn"  value="{{ old('size_name_bn') }}">
                        @error('size_name_bn')
                            <div class="alert alert-danger">
                                {{ $message }}
                            </div>
