...
use App\Repositories\ReturnRefundPolicyRepository;
use App\Http\Requests\ReturnRefundPolicyRequest;

class ReturnRefundPolicyController extends Controller
{
    protected $repo;
    public function __construct(ReturnRefundPolicyRepository $repo)
    {
        $this->repo= $repo;
     ...
     */
    public function update(ReturnRefundPolicyRequest $request, string $id)
    {
