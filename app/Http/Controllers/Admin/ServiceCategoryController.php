...
{
    protected $interface;
    public function __construct(ServiceCategoryInterface $interface)
    {
        $this->interface= $interface;
        $this->middleware(['permission:Service Category view'])->only(['index']);
        ...
        $this->middleware(['permission:Service Category status'])->only(['status']);
        $this->middleware(['permission:Service Category restore'])->only(['restore']);
        $this->middleware(['permission:Service Category delete'])->only(['delete']);
