...
{
    protected $interface;
    public function __construct(SubUnitInterface $interface)
    {
        ...
        $this->middleware(['permission:Sub Unit status'])->only(['status']);
        $this->middleware(['permission:Sub Unit restore'])->only(['restore']);
        $this->middleware(['permission:Sub Unit delete'])->only(['delete']);
        $this->middleware(['permission:Sub Unit show'])->only(['show']);
    }
    /**
     ...
     */
    public function update(SubUnitRequest $request, string $id)
    {
