...
use App\Http\Requests\CerficatesRequest;

class CerficatesController extends Controller
{
    protected $interface;
    public function __construct(CerficatesInterface $interface)
    {
     ...
     */
    public function store(CerficatesRequest $request)
    {
     ...
     */
    public function update(CerficatesRequest $request, string $id)
    {
